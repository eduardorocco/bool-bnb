...
function App() {
  ...
  return (
    <GlobalContext.Provider value={{ API_URL, search, setSearch, searchCity, setSearchCity, overlayLogin, setOverlayLogin, user, setUser, isLogin, showPropertyId, setShowPropertyId, isLoading, setIsLoading }}>
      <BrowserRouter>
        <Routes>
